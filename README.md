...
```
https://mcp.dexter-works.com/mcp
```

**Claude Code**

```bash
claude mcp add --transport http offers https://mcp.dexter-works.com/mcp
```
...
```json
{
  "mcpServers": {
    "offers": {
      "command": "npx",
      "args": ["-y", "mcp-remote", "https://mcp.dexter-works.com/mcp"]
    }
  }
}
```
...
```bash
curl "https://mcp.dexter-works.com/api/search_offers?q=Sony%20WH-1000XM6%20black&zip=83702"
```
